...
from reporter.utils import report_utils
from reporter.utils import reader
from reporter.utils import file_utils
...
for k in range(10):
    ...
    salesTblRows.append({"sNo": k+1, "name": "Item "+str(k+1), "cPu": costPu, "nUnits": nUnits, "revenue": costPu*nUnits})
...
# config = get_config()
# print(config)
# do_generate("../../static/dist/reports", init_data(config))

# local_reports = get_local_reports()
# print(local_reports)